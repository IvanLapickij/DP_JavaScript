 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,T){var I=N.length;N.push(T);e:for(;0<I;){var Z=I-1>>>1,ne=N[Z];if(0<o(ne,T))N[Z]=T,N[I]=ne,I=Z;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var T=N[0],I=N.pop();if(I!==T){N[0]=I;e:for(var Z=0,ne=N.length,Cr=ne>>>1;Z<Cr;){var jt=2*(Z+1)-1,Si=N[jt],Ot=jt+1,Pr=N[Ot];if(0>o(Si,I))Ot<ne&&0>o(Pr,Si)?(N[Z]=Pr,N[Ot]=I,Z=Ot):(N[Z]=Si,N[jt]=I,Z=jt);else if(Ot<ne&&0>o(Pr,I))N[Z]=Pr,N[Ot]=I,Z=Ot;else break e}}return T}function o(N,T){var I=N.sortIndex-T.sortIndex;return I!==0?I:N.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],f=1,d=null,m=3,v=!1,y=!1,g=!1,z=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(N){for(var T=n(u);T!==null;){if(T.callback===null)r(u);else if(T.startTime<=N)r(u),T.sortIndex=T.expirationTime,t(s,T);else break;T=n(u)}}function w(N){if(g=!1,h(N),!y)if(n(s)!==null)y=!0,wi(E);else{var T=n(u);T!==null&&xi(w,T.startTime-N)}}function E(N,T){y=!1,g&&(g=!1,p(_),_=-1),v=!0;var I=m;try{for(h(T),d=n(s);d!==null&&(!(d.expirationTime>T)||N&&!Ve());){var Z=d.callback;if(typeof Z=="function"){d.callback=null,m=d.priorityLevel;var ne=Z(d.expirationTime<=T);T=e.unstable_now(),typeof ne=="function"?d.callback=ne:d===n(s)&&r(s),h(T)}else r(s);d=n(s)}if(d!==null)var Cr=!0;else{var jt=n(u);jt!==null&&xi(w,jt.startTime-T),Cr=!1}return Cr}finally{d=null,m=I,v=!1}}var C=!1,k=null,_=-1,K=5,O=-1;function Ve(){return!(e.unstable_now()-O<K)}function _n(){if(k!==null){var N=e.unstable_now();O=N;var T=!0;try{T=k(!0,N)}finally{T?zn():(C=!1,k=null)}}else C=!1}var zn;if(typeof c=="function")zn=function(){c(_n)};else if(typeof MessageChannel<"u"){var ts=new MessageChannel,ud=ts.port2;ts.port1.onmessage=_n,zn=function(){ud.postMessage(null)}}else zn=function(){z(_n,0)};function wi(N){k=N,C||(C=!0,zn())}function xi(N,T){_=z(function(){N(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){y||v||(y=!0,wi(E))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(N){switch(m){case 1:case 2:case 3:var T=3;break;default:T=m}var I=m;m=T;try{return N()}finally{m=I}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,T){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var I=m;m=N;try{return T()}finally{m=I}},e.unstable_scheduleCallback=function(N,T,I){var Z=e.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?Z+I:Z):I=Z,N){case 1:var ne=-1;break;case 2:ne=250;break;case 5:ne=1073741823;break;case 4:ne=1e4;break;default:ne=5e3}return ne=I+ne,N={id:f++,callback:T,priorityLevel:N,startTime:I,expirationTime:ne,sortIndex:-1},I>Z?(N.sortIndex=I,t(u,N),n(s)===null&&N===n(u)&&(g?(p(_),_=-1):g=!0,xi(w,I-Z))):(N.sortIndex=ne,t(s,N),y||v||(y=!0,wi(E))),N},e.unstable_shouldYield=Ve,e.unstable_wrapCallback=function(N){var T=m;return function(){var I=m;m=T;try{return N.apply(this,arguments)}finally{m=I}}}})($u);Lu.exports=$u;var jd=Lu.exports;/**
 * @license React
...
`;function Bm({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=es,iterationCount:o=1}){return td`
...
`;function a1(e,t,n){switch(n){case"bottom-left":return t?Km:Rm;case"bottom-right":return t?Zm:jm;case"down":return e?t?bm:Lm:t?Jm:Om;case"left":return e?t?e1:$m:t?qm:es;case"right":return e?t?n1:Dm:t?t1:Fm;case"top-left":return t?r1:Am;case"top-right":return t?o1:Um;case"up":return e?t?l1:Wm:t?i1:Vm;default:return t?Gm:Im}}const Zi=e=>{const{big:t=!1,direction:n,reverse:r=!1,...o}=e,i=j.useMemo(()=>a1(t,r,n),[t,n,r]);return re(ad,{keyframes:i,...o})};S`
  from {
